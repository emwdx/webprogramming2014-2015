...
if(yourGuess<=3){ //Enter an expression here
    
    console.log("Your number is less than 3");
    
}

else if(yourGuess>=3 && yourGuess<=5){ //Enter an expression here
...
if(yourNumber%3==0 && yourNumber%5==0){
    ...
    console.log("Your number is divisible by 3 and 5."); //Enter a message here
    
    
}
else if(yourNumber%3==0 && yourNumber%5!=0){
    
    console.log("Your number is divisible by 3, but not 5." ); //Enter a message here
    
}

else if(yourNumber%3!=0 && yourNumber%5==0){
 
    console.log("Your number is divisible by 5, but not 3"); //Enter a message here
    
}

else{
    
    console.log("Your number is not divisible by 3 or 5."); //Enter a message here
...
if(firstLetter=='a' || firstLetter =='e' || firstLetter =='i' || firstLetter =='o' || firstLetter == 'u'){ //Enter your expression on this line.
...
if(teachScience){
    ...
    if(teachMath){
       console.log("You might be Mr. Weinberg or Mrs. Mullen." );
        
    }
    
    else{
        
        console.log("You are Mr. Fox or Mr. Haag." ); 
    ...
    if(teachMath){
       ...
       console.log("You are Mr. Deerwester") 
    }
    
    else{
       console.log("You are Mrs. Rooth or Ms. Payne.") 
...
if(dayOfWeek==0 || dayOfWeek==6){
    ...
    console.log("It's the weekend - sleep as late as you want!");
...
if(myGuess>myNumber){ //Enter a condition here inside the parentheses
 
alert('Your guess is too high. Guess again!');    
    
}
else if(myNumber>myGuess){ //Enter another condition here inside the parentheses
