...
numberOne = ReactiveVar(1);
numberTwo = ReactiveVar(0);
backgroundColor = ReactiveVar();
textCOlor = ReactiveVar();


Template.oneNumber.helpers({
    ...
    isOdd:function(){
     var currentValue = numberOne.get();
...
Template.oneNumber.events({
   
    'change #oneNumberInput': function(){
        
     var currentVal = $("#oneNumberInput").val();
     numberOne.set(currentVal);
     
     
      
    },
    'mouseenter #bigNumber':function(){
...
Template.chatRoomHeader.events({
...
Template.chatMessageEntry.helpers({
...
'keyup #chatMessageText':function(){
 
    backgroundColor.set($("#chatMessageText").val());
